...
from matches.views import create_match_view, list_matches_view, retrieve_match_view, finish_match_view, score_view
from tournaments.views import save_tournament_view, retrieve_tournament_view
from user_management.views import export_data_view, retrieve_user_place_view

urlpatterns = [
    path(Game.create_match, create_match_view),
    path(Game.finish_match, finish_match_view),
    path(Game.score, score_view),
    path(Game.user, retrieve_user_place_view),
